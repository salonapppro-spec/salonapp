...
**Допълнение:** Floating cards са изнесени извън телефона и далеч от copy колоната, така че да не покриват нито екрана, нито заглавието. `SMS напомняне` е сменено на `Имейл напомняне`, а feature редът `Промени влизат веднага в живо` е премахнат.
