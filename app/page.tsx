        ...
        <section id="salon-types" className="bg-[#F8EBDD] px-8 py-14 lg:px-16 md:py-16 scroll-mt-16">
          <RevealOnScroll>
            <h2 className="playfair mb-3 text-center text-3xl font-bold text-[#3D1F0A] md:text-4xl">
              Създаден за всеки вид салон за красота
            </h2>
            <p className="mx-auto mb-10 max-w-2xl text-center text-base text-[#6E6A63]">
              SalonApp работи така, както работиш и ти — прически, маникюр,
              козметика, масаж или грижа за любимци.
            </p>
          </RevealOnScroll>
          <div className="mx-auto grid max-w-4xl grid-cols-2 gap-4 sm:grid-cols-3">
            {[
              { title: "Фризьорски салони", desc: "Онлайн резервации и график, който виждаш от телефона." },
              { title: "Козметични салони", desc: "Записване на часове и картон на всеки клиент." },
              { title: "Маникюр и педикюр", desc: "Клиентите запазват час сами, без обаждания." },
              { title: "Барбершопи", desc: "Резервации по всяко време, без пропуснати клиенти." },
              { title: "Масажни студиа", desc: "Графикът и историята на клиентите на едно място." },
              { title: "Груминг салони", desc: "Онлайн записване за грижа за домашни любимци." },
            ].map((t, i) => (
