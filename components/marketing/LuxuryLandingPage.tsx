...
const plans = [
  ...
  },
  {
    ...
    features: ["Всичко от Стандарт", "SEO и AIO", "Имейл след посещение за отзиви", "По-силен local presence", "По-скъп вид за бранда"],
    featured: true,
  },
  {
    name: "Премиум",
    ...
    features: ["До 3 специалиста — отделни панели и графици, общ сайт", "Всичко от Про", "SMS и Viber", "По-малко пропуснати часове", "По-добра грижа след посещение"],
    featured: false,
  },
  {
    name: "Колектив",
