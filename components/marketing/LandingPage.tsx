...
const plans = [
  ...
  },
  {
    ...
    featured: true,
    tag: "Най-избиран",
    features: ["1 Специалист", "Всичко от Стандарт", "Паралелни услуги", "Google Business настройка", "SEO и AI оптимизация"],
  },
  {
    name: "ПРЕМИУМ",
    price: "49",
    featured: false,
    features: ["1 Специалист", "Всичко от Про", "SMS и Viber напомняния", "Имейл след посещение", "По-силен automation пакет"],
  },
  {
    name: "КОЛЕКТИВ",
    price: "49",
