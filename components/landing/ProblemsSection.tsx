...
const MoonIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke={LP.accent} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width={22} height={22}>
